...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    - The useRouteMatch component is useful anytime you are using a <Route>, and you want to gain access to its match data. It matches the URL just like a Route would.
1. How would you explain form validation to someone who has never programmed before?
    - We need to make sure our data is coming in a way that we need it to for our back end. For example, when making sure we are getting an email or when we need the user to accept the terms and conditions before creating an account. 
1. In 1-2 sentences, define end to end testing.
    End to end testing refers to a software testing method that tests the applications workflow from beginning to end. The aim is to replicate real world scenarios to ensure the system can be validated. 
